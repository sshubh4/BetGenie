...
# Input/output files
input_csv = 'future_filtered_times.csv'  # Your input CSV filename
output_csv = 'future_weather_data.csv'  # Output CSV filename for combined hourly data
...
if all_hourly_dfs:
    ...
    print(f"All weather data combined and saved to '{output_csv}'.")
else:
