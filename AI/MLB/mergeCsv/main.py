...
if __name__ == "__main__":
    ...
    # Step 1.5 - add_game_in_day_to_csv for team game logs
    run_script("add_game_in_day.py")
    ...
    run_script("rolling_stats_merge.py")

    # # Step 5.5 - encoding.py
    # run_script("encoding.py")
    ...
    # stepp 11 - encode the future file
    # encode()

    ###final output files
    #final_future_processing_data.csv, merged_data.csv, filtered_times.csv, future_filtered_times.csv
    #combined_weather_data.csv, final_merged_data.csv
